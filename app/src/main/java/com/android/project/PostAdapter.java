...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    //вью холдер сохр ссылки на необх в элементе списка шаблоны
    //ресайклер - комп пи, создает прокруч список
    //связь данных с компонентом + отслеж изменения
    ...
    //загрузка данных по указ позиции
    @Override
